    ...
    <div class="view-table">
        <div class="container">
            <div class="view-heading">
                <h2>الموائد المتاحة!</h2>
                <p>يمكنك من خلال هذه الصفحة رؤية الموائد المتاحة..</p>
            </div>
                    ...
                    if (city_id == ele.id) {
                        ...
                        governments.forEach(function(ele) {
                            if (ele.id == government_id) {
                                governorate_name_ar = ele
                                    .governorate_name_ar
                            }
                        })
                    }
                })
                distance = getDistanceBetweenPoints($("#userLat").val(), $("#userLng").val(), ele['lat'], ele['lng']);
